    ...
    private static void testCreateUser(String rollNumber, String firstName, String lastName, String phoneNumber, String emailId) {
        ...
        try {
            ...
            String jsonInputString = String.format(
                "{\"rollNumber\": %s, \"firstName\": %s, \"lastName\": %s, \"phoneNumber\": %s, \"emailId\": %s}",
                toJsonValue(rollNumber), toJsonValue(firstName), toJsonValue(lastName), toJsonValue(phoneNumber), toJsonValue(emailId)
            );
